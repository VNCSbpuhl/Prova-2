...
const config = {
    user: process.env.DB_USER || "VISR_OLIVEIRA",
    password: process.env.DB_PASSWORD || 'Unhaazul24!',
    server: process.env.DB_SERVER || "brazuca-server2.database.windows.net",
    database: process.env.DB_DATABASE || "brazuca-server2",
    options: {
        encrypt: true
    }
};
